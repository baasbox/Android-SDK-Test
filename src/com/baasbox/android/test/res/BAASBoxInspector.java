...
public class BAASBoxInspector {
	...
	public BAASBoxInspector(Context context) throws Exception {
		...
		this.BAASBOX_PERSISTENCE_PREFIX = (String) getFieldValue(
				"BAASBOX_PERSISTENCE_PREFIX", null);
		this.BB_SESSION_PERSISTENCE_KEY = (String) getFieldValue(
				"BB_SESSION_PERSISTENCE_KEY", null);
		this.USERNAME_PERSISTENCE_KEY = (String) getFieldValue(
				"USERNAME_PERSISTENCE_KEY", null);
		this.PASSWORD_PERSISTENCE_KEY = (String) getFieldValue(
				"PASSWORD_PERSISTENCE_KEY", null);
	}

	private static final Object getFieldValue(String name, BAASBox box)
